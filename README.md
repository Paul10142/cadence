...
your choice of what a click on the icon does, opening at login, and automatic
pausing while your Mac sleeps or the screen is locked.
...
3. Open it. A stopwatch appears in your menu bar — there is no dock icon and no
   window, which is the point. It offers to open itself at login the first time;
   you can change that later under **Preferences → Open Cadence at login**.
